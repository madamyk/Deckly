    ...
    <Screen padded={false} edges={['left', 'right', 'bottom']}>
      ...
      <View style={{ flex: 1, padding: t.spacing.lg, gap: 14 }}>
        ...
        <Surface tone="muted" padding={14}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10, paddingTop: 10, opacity: createdDeckId ? 0.6 : 1 }}>
            {DECK_ACCENTS.map((a) => {
        ...
        {!createdDeckId ? (
          ...
          <View style={{ gap: 10 }}>
            ...
            <Button
              title="Add a card"
              onPress={() =>
                router.replace({ pathname: '/deck/[deckId]/cards/new', params: { deckId: createdDeckId } })
              }
            />
            <Button
              title="Import CSV"
